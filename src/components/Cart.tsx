            ...
            <DialogPanel className="pointer-events-auto w-screen max-w-md bg-white shadow-xl">
              <div className="flex h-full flex-col px-4 py-6 sm:px-6">
                ...
                <div className="border-t border-gray-200 pt-6">
                  <div className="flex justify-between text-base font-medium text-gray-900 px-4 sm:px-6">
                    <p>Subtotal</p>
                    <p>${subtotal.toFixed(2)}</p>
                  </div>
                  <p className="mt-0.5 text-sm text-gray-500 px-4 sm:px-6">
                  ...
                  <div className="mt-6 flex justify-center text-sm text-gray-500 px-4 sm:px-6">
                    <button
                      onClick={() => setIsCartOpen(false)}
